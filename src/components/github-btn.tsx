export default function GithubButton() {
	return (
		<div className='button-icon bg-githubGray flex border-2 w-fit h-fit cursor-pointer hover:border-green-400 group'>
			...
			<div className='cube transition-all duration-300 w-44 h-5 text-githubGray-text'>
				<span className='side front uppercase'>Follow me</span>
